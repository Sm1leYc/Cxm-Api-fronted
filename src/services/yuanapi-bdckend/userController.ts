...
/** 此处后端没有提供注释 POST /user/signIn */
export async function signIn(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.signInParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean>('/user/signIn', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /user/update/pwd */
...
/** 此处后端没有提供注释 POST /user/update/updateSk */
export async function updateSk(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.updateSkParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean>('/user/update/updateSk', {
    method: 'POST',
    params: {
      ...params,
    },
